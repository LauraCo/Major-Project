...
The minor differences between $x$ \& $y$ and $y$ \& $z$, to make them indiscernible, may actually still result in a fairly significant difference between $x$ and $z$, especially in instances such as image values.
