...
It follows that entropy can only ever take a value between 0 and 1, with an entropy of 1 having a 50\% probability rate, and an entropy of 0 being 100\% certain.
...
Indiscernibilty as defined by Pawlak in \say{Granularity of knowledge, indiscernibility and rough sets} \cite{Pawlak_1998}:

\begin{quotation}
  \textit{However, more interesting seems to assume that the indiscernibility relation is formalized as a tolerance relation, i.e., transitivity of indiscernibilty is denied in this case, for, if t is indiscernible from y and y is indiscernible from z then not necessarily x is indiscernible from z.}
\end{quotation}
