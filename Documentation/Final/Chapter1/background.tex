...
\begin{figure}[!h]
  ...
  \caption{Breast tissue composition. Image Source: EU Commission: Atlas on Mortality \cite{European_Commission_2009}}
...
\begin{figure}[H]
  ...
  \begin{subfigure}[t]{0.2\textwidth}
        \includegraphics[width= \textwidth]{Chapter1/background-img/CC.jpg}
        \caption{Cranial-Caudal: Case courtesy of Dr Garth Kruger, Radiopaedia.org, rID: 18580}
        \label{fig:CC}
    \end{subfigure}
    \begin{subfigure}[t]{0.2\textwidth}
          \includegraphics[width=\textwidth]{Chapter1/background-img/MLO.jpg}
          \caption{Medio-Lateral Oblique: Case courtesy of A.Prof Frank Gaillard, Radiopaedia.org, rID: 12608}
          \label{fig:MLO}
    \end{subfigure}
    \begin{subfigure}[t]{0.2\textwidth}
          \includegraphics[width=1.2\textwidth]{Chapter1/background-img/ML.jpg}
