...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.4\textwidth]{/Users/lauracollins/Git/Major-Project/Documentation/Final/Chapter2/technical-img/rotation.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.4\textwidth]{/Users/lauracollins/Git/Major-Project/Documentation/Final/Chapter2/technical-img/big_scan.jpg}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.4\textwidth]{/Users/lauracollins/Git/Major-Project/Documentation/Final/Chapter2/technical-img/mdb196.png}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[t]{0.3\textwidth}
        \includegraphics[width=\textwidth]{/Users/lauracollins/Git/Major-Project/Documentation/Final/Chapter2/technical-img/morph.png}
    ...
    \begin{subfigure}[t]{0.3\textwidth}
        \includegraphics[width=\textwidth]{/Users/lauracollins/Git/Major-Project/Documentation/Final/Chapter2/technical-img/regionprops.png}
        \caption{Regionprops detecting areas and superimposing the area information on a mammogram.}
        \label{fig:regionprops}
    \end{subfigure} \hfill
    \begin{subfigure}[t]{0.3\textwidth}
      \includegraphics[width=\textwidth]{/Users/lauracollins/Git/Major-Project/Documentation/Final/Chapter2/technical-img/shape_recog.png}
    ...
    \begin{subfigure}[t]{0.3\textwidth}
      \includegraphics[width=\textwidth]{/Users/lauracollins/Git/Major-Project/Documentation/Final/Chapter2/technical-img/remove-white-220.png}
      \caption{Removing areas of grey-level value above 220.}
      \label{fig:remove-white}
    \end{subfigure} \hfill
    \begin{subfigure}[t]{0.3\textwidth}
      \includegraphics[width=\textwidth]{/Users/lauracollins/Git/Major-Project/Documentation/Final/Chapter2/technical-img/remove-white.png}
      \caption{Lower grey-level removal threshold to 200.}
      \label{fig:remove-white-200}
    \end{subfigure} \hfill
    \begin{subfigure}[t]{0.3\textwidth}
      \includegraphics[width=\textwidth]{/Users/lauracollins/Git/Major-Project/Documentation/Final/Chapter2/technical-img/other-scan.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[scale=0.4]{/Users/lauracollins/Git/Major-Project/Documentation/Final/Chapter2/technical-img/draw-to-remove.png}
...
\label{sssec:load}
 ...
 When investigating the Congealing demo code, it became apparent that comments were utilised in the reading-in of image information.
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.8\textwidth]{/Users/lauracollins/Git/Major-Project/Documentation/Final/Chapter2/technical-img/timeToRunBinaryCongeal.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.8\textwidth]{/Users/lauracollins/Git/Major-Project/Documentation/Final/Chapter2/technical-img/totalTime.png}
