...
\begin{table}[H]
  ...
  \begin{tabular}{|c|c|c|c|}
    \hline
      ...
      \textbf{BI-RADS I} & \textbf{BI-RADS II} & \textbf{BI-RADS III} & \textbf{BI-RADS IV} \\ \hline
      ...
      - & - &  mdb291.pgm & - \\ \hline
  \end{tabular}
  \caption{The four sample set directories with the Mini-MIAS scans sorted into their BI-RADS classification.}
  \label{table:image-info}
\end{table}

The following groundtruth data was provided by Dr. Reyer Zwiggelaar (rrz@aber.ac.uk).

\begin{table}[H]
  \begin{center}
    \pgfplotstabletypeset[
        col sep=comma,
        columns={Mini-MIAS_image,BIRADS_class,Mini-MIAS_image,BIRADS_class,Mini-MIAS_image,BIRADS_class},
        every head row/.style={before row=\toprule,after row=\midrule},
        every last row/.style={after row=\bottomrule},
        column type=p{17mm},
        display columns/0/.style={
            select equal part entry of={0}{3},
            string type,
            column name={Mini-MIAS Image (1/3)},
        },
        display columns/1/.style={
            select equal part entry of={0}{3},
            string type,
            column name={BI-RADS Class (1/3)},
            dec sep align={p{17mm}|},
            column type/.add={}{|},
        },
        display columns/2/.style={select equal part entry of={1}{3},string type, column name={Mini-MIAS Image (2/3)}},
        display columns/3/.style={select equal part entry of={1}{3},string type, column name={BI-RADS Class (2/3)},            dec sep align={p{17mm}|},column type/.add={}{|}},
        display columns/4/.style={select equal part entry of={2}{3},string type, column name={Mini-MIAS Image (3/3)}},
        display columns/5/.style={select equal part entry of={2}{3},string type, column name={BI-RADS Class (3/3)}},
        ]{Appendix5/input/birad1.csv}
    \caption{Ground Truth data - BI-RADS I}
    \label{table:ground-truth-1}
  \end{center}
\end{table}
...
\begin{table}[H]
  \begin{center}
    \pgfplotstabletypeset[
        ...
        display columns/4/.style={select equal part entry of={2}{3},string type, column name={Mini-MIAS Image (3/3)}},
        display columns/5/.style={select equal part entry of={2}{3},string type, column name={BI-RADS Class (3/3)}},
        ]{Appendix5/input/birad2.csv}
    \caption{Ground Truth data - BI-RADS II}
    \label{table:ground-truth-2}
  \end{center}
\end{table}
...
\begin{table}[H]
  \begin{center}
    \pgfplotstabletypeset[
        ...
        display columns/4/.style={select equal part entry of={2}{3},string type, column name={Mini-MIAS Image (3/3)}},
        display columns/5/.style={select equal part entry of={2}{3},string type, column name={BI-RADS Class (3/3)}},
        ]{Appendix5/input/birads3.csv}
    \caption{Ground Truth data - BI-RADS III}
    \label{table:ground-truth-3}
  \end{center}
\end{table}
...
\begin{table}[H]
  \begin{center}
    \pgfplotstabletypeset[
        ...
        display columns/4/.style={select equal part entry of={2}{3},string type, column name={Mini-MIAS Image (3/3)}},
        display columns/5/.style={select equal part entry of={2}{3},string type, column name={BI-RADS Class (3/3)}},
        ]{Appendix5/input/birads4.csv}
    \caption{Ground Truth data - BI-RADS IV}
    \label{table:ground-truth-4}
  \end{center}
\end{table}
